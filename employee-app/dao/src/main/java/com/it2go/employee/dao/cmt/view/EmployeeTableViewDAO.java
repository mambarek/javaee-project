...
public class EmployeeTableViewDAO {
    ...
    public List<EmployeeTableItem> getEmployeeItems() {
        String query = "select new com.it2go.employee.dto.EmployeeTableItem(empl.id, empl.firstName, empl.lastName, p.firstName, empl.creationDate)" +
    ...
    public List<EmployeeTableItem> getEmployeeItems(Map<String, Object> params) {
        ...
        query.append("select new com.it2go.employee.dto.EmployeeTableItem(empl.id, empl.firstName, empl.lastName, p.firstName, empl.creationDate)" +
                " from Employee as empl left outer join empl.createdBy as p ");
