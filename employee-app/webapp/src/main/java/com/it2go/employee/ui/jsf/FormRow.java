...
@FacesComponent(createTag = true, namespace = "http://xmlns.it2go.com/jsf/employee",
        tagName = "FormRow", value = "com.it2go.employee.ui.jsf.FormRow")
public class FormRow extends UIInput {
