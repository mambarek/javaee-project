package com.it2go.employee.services.ws.test;
...
public class EmployeeRepositoryServiceTest {
    ...
    private EmployeeRepositoryService getEmployeeService(){
        ...
        final QName serviceName
                = new QName("http://services.employee.it2go.com/", "EmployeeRepositoryService");
        final QName portName
                = new QName("http://services.employee.it2go.com/", "EmployeeRepositoryServiceImplPort");
